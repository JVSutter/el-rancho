...
class TicketOrderSynchronizer:
    ...
    def __init__(self) -> None:
        ...
        self.has_ticket_been_called_lock: Lock = Lock()

        self.has_order_been_made: Dict[int, Event] = {}
        self.has_order_been_made_lock: Lock = Lock()
    ...
    def search_ticket_in_dict(self, ticket_num: int, dict_to_verify: Dict[int, Event], dict_lock: Lock) -> None:
        with dict_lock:
